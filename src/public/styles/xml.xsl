...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl">Generated by <a href="https://gitlab.com/tahsingokalp/laravel-sitemap" target="_blank" title="Sitemap generator for Laravel">tahsingokalp/laravel-sitemap</a>. This is styled xml sitemap, sorted by update date.</p>
